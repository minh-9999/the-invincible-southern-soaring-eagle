...
void EngineSettingsDialog::setupUI()
{
    ...
    setupThinkConfigTab(thinkConfigTab);
}
...
void EngineSettingsDialog::setupThinkConfigTab(QWidget *tab)
{
    ...
    // // Time by score table
    // QTableWidget *scoreTable = new QTableWidget(20, 2);
    ...
    // for (int i = 0; i < 20; ++i)
    // {
    //     scoreTable->setItem(i, 0, new QTableWidgetItem(QString::number(600 - i * 50)));
    //     scoreTable->setItem(i, 1, new QTableWidgetItem(QString::number(10 + i)));
    // }

    // // Không set fixed height, hoặc set maximum height
    ...
    // QSpinBox *inMovesSpin = new QSpinBox(); inMovesSpin->setRange(0, 999);
    // QLabel *movesUseTimeLabel = new QLabel("Moves Use Time");
    // QSpinBox *secPerMove1 = new QSpinBox(); secPerMove1->setRange(0, 999);
    ...
    // QSpinBox *afterMinuteSpin = new QSpinBox(); afterMinuteSpin->setRange(0, 999);
    // QLabel *minuteUseTimeLabel = new QLabel("Minute Use Time");
    // QSpinBox *secPerMove2 = new QSpinBox(); secPerMove2->setRange(0, 999);
    ...
    // grid->addWidget(timeDepthRadio, 0, 0, 1, 1);
    // grid->addWidget(scoreRadio, 0, 6, 1, 1);
    ...
    // grid->addWidget(depthCheck, 2, 0);
    // grid->addWidget(depthSpin, 2, 1);
    // grid->addWidget(lLabel, 2, 2);

    // grid->addWidget(scoreTable, 1, 6, 5, 3);
    ...
    // grid->addWidget(sLabel3, 5, 2);
    // grid->addWidget(incLabel, 5, 3);
    // grid->addWidget(incSpin, 5, 4);
    // grid->addWidget(sLabel4, 5, 5);
    ...
    // grid->addWidget(secPerMove1, 7, 4);
    // grid->addWidget(secPerLabel1, 7, 5);
    ...
    // grid->addWidget(secPerMove2, 8, 4);
    // grid->addWidget(secPerLabel2, 8, 5);
